            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div class="subscribe-content">
                        <p>
                            <h2>Third Party Auditor Challenge </h2>
                            <form action="TPAFileGetChallange.jsp" method="POST" class="table-responsive" style="width:100%" >
                                <table>
                                    
                                    <tr style="color: white;"><td></td>
                                        <td>Enter Public key</td>
                                        <td><input type="text" name="publickey" required="" ></td>
                                    </tr>
                                   <tr style="color: white;"><td></td>
                                        <td>Enter File ID</td>
                                    ...
                                    <tr>
                                        <td></td><td></td>
                                        <td><button type="submit" value="Challenge" class="main-button-icon">Challenge</button></td>
                                    </tr>
                                    <tr>
                                        <td>
                                ...
                                if (msg != null && msg.equalsIgnoreCase("success")) {
                                    out.println("<font color='WHITE'>File Audit Success </font>");
                                } else if (msg != null && msg.equalsIgnoreCase("failed")) {
                                    out.println("<font color='PINK'>Challenge Failed Due to invalid Keys</font>");
                                }
