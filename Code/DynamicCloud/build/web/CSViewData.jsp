...
<html lang="en">
  ...
  <head>
    ...
    <jsp:include page="csmenu.jsp"></jsp:include>

    <!-- ***** Main Banner Area Start ***** -->
   <section class="section" id="subscribe">
        <div class="container">
             <h2>View Meta info</h2>
            <table border="2px" class="table table-hover table-dark">
                                ...
                                <tbody>
                                    ...
                                    try(Connection con = DBConnections.getDBConnection()){
                                        String sqlQuery = "select *from ownersfiles";
                                     ...
                                     <tr scope="row" style="color: BLUE; background-color:#FFFCBB">
                                        ...
                                        <td><a class="btn-link" href="./CloudServerAck.jsp?id=<%=id%>"
                                               style="color:DARKBLUE">Acknowledge</a></td>
                                        <% }else{ %>
                                        <td> Acknowledge Sent</td>
                                        <% } %>
                                    </tr>
