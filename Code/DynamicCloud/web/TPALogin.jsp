            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="section-heading">
                        <h6>&nbsp;</h6>
                        <h2>Third Party Auditor Login Form</h2>
                    </div>
                    <div class="subscribe-content">
                        <p>Select the data and encrypt it with symmetric key cryptography.</p>
                        <center>
                        <div class="subscribe-form">
                             <form action="TPALoginCheck.jsp" method="POST" class="table-responsive" style="width:100%">
                                <table>
                                ...
                                if (msg != null && msg.equalsIgnoreCase("success")) {
                                    out.println("<font color='WHITE'>Login Successfull </font>");
