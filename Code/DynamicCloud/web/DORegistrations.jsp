                ...
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div class="subscribe-content">
                        ...
                        <div class="subscribe-form">
                             <form action="./DORegisterActions" method="POST" class="table-responsive" style="width:100%">
                                <table>
                                    ...
                                    <tr>
                                        <td></td><td></td>
                                        <td><button type="submit" value="Register" class="main-stroked-button">Register</button></td>
                                    </tr>
                                    <tr>
                                        <td>
