...
<html lang="en">
  ...
  <head>
    ...
    <jsp:include page="domenu.jsp"></jsp:include>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="section-heading">
                        <h6>&nbsp;</h6>
                        <h2>Data Owner Data Upload Form</h2>
                    </div>
                    <div class="subscribe-content">
                        <p>Select the data and encrypt it with symmetric key cryptography.</p>
                        <center>
                        <div class="subscribe-form">
                            <form action="./DOUploadAction" method="POST" class="table-responsive" style="width:100%" enctype="multipart/form-data">
                                <table>
                                    ...
                                    <tr>
                                        <td></td><td></td>
                                        <td><button type="submit" value="Register" class="main-button-icon">Upload</button></td>
                                    </tr>
                                    <tr>
                                        <td>
